...
FUNTOUCH.X // x-pos current
FUNTOUCH.Y // y-pos current
...
FUNTOUCH.setCursorStyle = function (style) {
    // 'default', 'pointer',
    style = style || 'default';
    if (FUNTOUCH.canvas) {
        FUNTOUCH.canvas.style.cursor = style;
    }
}

FUNTOUCH.isTouchSupported = function () {
    // http://www.kirupa.com/html5/examples/is_touch_supported.htm
...
FUNTOUCH.mouseXY = function (e) {
    ...
    FUNTOUCH.X = FUNTOUCH.scalefactor*(e.pageX - FUNTOUCH.absoluteOffsetLeft());
    FUNTOUCH.Y = FUNTOUCH.scalefactor*(e.pageY - FUNTOUCH.absoluteOffsetTop());
}
...
FUNTOUCH.touchXY = function (e) {
    ...
    FUNTOUCH.lastX *= FUNTOUCH.scalefactor;
    FUNTOUCH.lastY *= FUNTOUCH.scalefactor;
    FUNTOUCH.X = FUNTOUCH.lastX;
    FUNTOUCH.Y = FUNTOUCH.lastY;
    /* for (var i = 0; i < e.changedTouches.length; i++) {
